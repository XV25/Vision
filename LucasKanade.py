...
def get_from_pic(img1, img2, mask, color2):
    ...
    return(img_C,mask,good_new,good_old)
...
def get_from_vid(name_vid):
    ...
    while success:
        ...
        if success:
            imgC,mask,gn,go = get_from_pic(old_image, new_image, mask ,color)
